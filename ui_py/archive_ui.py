...
"}")
    ...
    def retranslateUi(self, WindowArch):
        ...
        self.combo_type.setItemText(3, _translate("WindowArch", "Скорость/Сопротивление"))
        self.combo_type.setItemText(4, _translate("WindowArch", "Температура/Сопротивление"))
