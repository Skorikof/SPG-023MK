...
class Ui_WindowArch(object):
    def setupUi(self, WindowArch):
        ...
        self.power_lbl.setGeometry(QtCore.QRect(640, 210, 186, 30))
        self.power_lbl.setMinimumSize(QtCore.QSize(0, 30))
        self.power_lbl.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.power_le.setGeometry(QtCore.QRect(880, 210, 80, 30))
        self.power_le.setMinimumSize(QtCore.QSize(80, 30))
        self.power_le.setMaximumSize(QtCore.QSize(80, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
...
"}")
    ...
    def retranslateUi(self, WindowArch):
        ...
        self.lbl_push_force.setText(_translate("WindowArch", "Динамическая\n"
"выталкивающая\n"
"сила"))
